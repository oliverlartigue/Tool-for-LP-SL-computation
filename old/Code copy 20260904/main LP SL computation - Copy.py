...
# GET DATA _ v1
# get LP MSF mapping
df_mapping = pd.read_excel(r'C:\Users\oliver.lartigue\OneDrive - Rio Tinto\Documents\31. Tool for LP SL computation\Input Files\LP MSF mapping.xlsx')
...
# get MSF shut
df_rawshuts = pd.read_excel(r'C:\Users\oliver.lartigue\OneDrive - Rio Tinto\Documents\31. Tool for LP SL computation\Input Files\MSF shuts.xlsx')
...
output_file_2 = r"C:\Users\oliver.lartigue\OneDrive - Rio Tinto\Documents\31. Tool for LP SL computation\Output_splitShuts.xlsx"
df_split.to_excel(output_file_2, index=False)
print(f"Saved to: {output_file_2}")
output_file_3 = r"C:\Users\oliver.lartigue\OneDrive - Rio Tinto\Documents\31. Tool for LP SL computation\Output_SL_hours_opDay.xlsx"
df_SL_opDay.to_excel(output_file_3, index=False)
print(f"Saved to: {output_file_3}")
output_file_4 = r"C:\Users\oliver.lartigue\OneDrive - Rio Tinto\Documents\31. Tool for LP SL computation\Output_SL_hours_splitWeek.xlsx"
