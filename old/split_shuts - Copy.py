import pandas as pd
# FUNCTION split overlapping shut for each asset/MSF code

# INPUT : dataframe with 5 columns: index, asset, MSFcode, startdate, enddate. Each row represent a shut for an asset with an MSFcode and a shut startdate and enddate :
# - index is unique
# - multiple assets
# - each asset has muliple MSFcode
# -  each MSF code has multiple shuts (muliple rows of a shut startdate and enddate)

# OUTPUT : dataframe with 5 columns: index, asset, MSFcode, startdate, enddate. 
# Each row represent a unique combination of shut for an asset with an MSFcode and a shut startdate and enddate :
# - index is not unique anymore
# - multiple assets
# - each asset has muliple MSFcode
# -  each MSF code has multiple shuts (muliple rows of a shut startdate and enddate)
